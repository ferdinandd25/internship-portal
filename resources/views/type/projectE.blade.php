...
<section id="ProjectContainer">
    <div class="Project">
        <div class="button-container">
            <button class="btn btn-secondary" style="font-size: 14px;">Human Capital</button>
...
<div class="containerAdmin">
    ...
    <div style="width: 100%; height: 100%; color: black; font-size: 20px; font-family: Inter; font-weight: 500; word-wrap: break-word">
        ...
        <li>Pengembangan terhadap system aplikasi internal HC - LMS, sehingga dapat menjadi media untuk pelatihan dan pengembangan karyawan</li></br>
    
        <strong>Technical Requirements : </strong> 
        <li>Design Visual, UI UX</li></br>
    </div>
