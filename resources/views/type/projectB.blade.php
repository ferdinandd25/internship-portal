...
<section id="ProjectContainer">
    <div class="Project">
        <div class="button-container">
            <button class="btn btn-secondary" style="font-size: 14px;">Cloud BusDev</button>
...
<div class="containerAdmin">
    ...
    <div style="width: 100%; height: 100%; color: black; font-size: 20px; font-family: Inter; font-weight: 500; word-wrap: break-word">
        ...
        <li>Project Internship CBNCloud Business Development</li>
        <li>Product Manager & Specialist</li></br>
        ...
        <li>Market & Competitor Research for our existing product/services, and on-going product development</li></br>
    
        <strong>Technical Requirements : </strong> 
        <li>(Business and Technical) Analyst.Able to analyse and interpret data, feedback and research, then present them </li></br>
    </div>
